...
void
PLT_MicroMediaController::SetMediaRenderer(const char* mediaRendererName){
	...
	while(res!=NPT_SUCCESS){
		//printf("waiting for the media renderer to come up!\n");
		...
		while (entry) {
			...
			if(0 == strcmp(mediaRendererName, name)){
				printf("****renderer discovered and set****\n");
